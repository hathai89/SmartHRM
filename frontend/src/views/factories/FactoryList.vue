<template>
  <div class="factory-list">
    ...
    <template v-else>
      ...
      <!-- Hiển thị cấu trúc cây xí nghiệp -->
      <div v-else-if="activeTab === 'tree'">
        <factory-tree
          :initial-expanded="true"
          @factory-saved="handleFactorySaved"
        />
      </div>
    </template>
...
import FactoryTree from '@/components/factories/FactoryTree.vue'
...
export default {
  ...
  methods: {
    ...
    handleFactorySaved(result) {
      if (result.success) {
        this.setSuccess(result.message)
        // Cập nhật lại danh sách xí nghiệp
        this.fetchFactories()
      } else {
